...
{
	if (region.l.ag === region.t.ag)
	{
		return 'on line ' + region.l.ag;
	}
	return 'on lines ' + region.l.ag + ' through ' + region.t.ag;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b6: 'hidden', b_: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b6: 'mozHidden', b_: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b6: 'msHidden', b_: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b6: 'webkitHidden', b_: 'webkitvisibilitychange' }
		: { b6: 'hidden', b_: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		function done(response) {
			callback(toTask(request.b3.a(response)));
		}

		var xhr = new XMLHttpRequest();
		xhr.addEventListener('error', function() { done($elm$http$Http$NetworkError_); });
		xhr.addEventListener('timeout', function() { done($elm$http$Http$Timeout_); });
		xhr.addEventListener('load', function() { done(_Http_toResponse(request.b3.b, xhr)); });
		$elm$core$Maybe$isJust(request.cx) && _Http_track(router, xhr, request.cx.a);

		try {
			xhr.open(request.cg, request.V, true);
		} catch (e) {
		...
		request.bY.a && xhr.setRequestHeader('Content-Type', request.bY.a);
		xhr.send(request.bY.b);
...
function _Http_configureRequest(xhr, request)
{
	...
	xhr.timeout = request.cv.a || 0;
	xhr.responseType = request.b3.d;
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a1: fragment, a6: host, bi: path, bk: port_, bn: protocol, bo: query};
	});
...
var $author$project$AonTool$defaultFlags = {ah: $elm$core$Dict$empty};
	...
	function (toResult, response) {
		switch (response.$) {
			...
			case 3:
				...
				return $elm$core$Result$Err(
					$elm$http$Http$BadStatus(metadata.cs));
			default:
				var body = response.b;
				return A2(
			...
			return $elm$http$Http$Request(
				{
					bW: r.bW,
					bY: r.bY,
					b3: A2(_Http_mapExpect, func, r.b3),
					b5: r.b5,
					cg: r.cg,
					cv: r.cv,
					cx: r.cx,
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bW: false, bY: r.bY, b3: r.b3, b5: r.b5, cg: r.cg, cv: r.cv, cx: r.cx, V: r.V}));
};
			...
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[
						...
						$elm$http$Http$request(
						{
							bY: $elm$http$Http$jsonBody(
								A2($author$project$AonTool$buildDataBody, model, searchAfter)),
							b3: A2($elm$http$Http$expectJson, $author$project$AonTool$GotDataResult, $author$project$AonTool$esResultDecoder),
							b5: _List_Nil,
							cg: 'POST',
							cv: $elm$core$Maybe$Just(10000),
							cx: $elm$core$Maybe$Nothing,
							V: model._ + '/_search?track_total_hits=true'
						})
					])));
	});
...
var $author$project$AonTool$flagsDecoder = A3(
	...
	function (localStorage) {
		return $elm$json$Json$Decode$succeed(
			{
				ah: A2($elm$core$Maybe$withDefault, $author$project$AonTool$defaultFlags.ah, localStorage)
			});
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {i: index, cf: match, ci: number, bC: submatches};
	});
...
var $author$project$AonTool$updateCandidates = function (_v0) {
				...
				switch (_v1) {
					...
					case 1:
						return A2(
							...
							$elm$core$String$length(b.m.g),
							$elm$core$String$length(a.m.g));
					default:
						return 2;
				}
			}),
	...
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{aq: candidates, O: $elm$core$Maybe$Nothing}),
		cmd);
};
		...
		_Utils_Tuple2(
			function (model) {
				return A3(
					...
					model,
					$elm$core$Dict$toList(flags.ah));
			}(
				{J: $author$project$AonTool$defaultAonUrl, aq: _List_Nil, O: $elm$core$Maybe$Nothing, P: $elm$core$Maybe$Nothing, Q: $elm$core$Maybe$Nothing, F: 0, x: _List_Nil, _: $author$project$AonTool$defaultElasticsearchUrl, af: false, A: '', aj: false, d: $author$project$AonTool$emptySelection, k: $elm$core$Dict$empty, c: '', aL: false, r: $elm$core$Maybe$Nothing}),
...
var $author$project$AonTool$FixNewlinesPressed = {$: 11};
var $author$project$AonTool$UndoPressed = {$: 32};
...
var $author$project$AonTool$applyCandidate = F2(
	function (candidate, text) {
		var endIndex = candidate.i + $elm$core$String$length(candidate.m.g);
		return A4(
...
var $author$project$AonTool$getSubmatch = F3(
	function (index, _default, match) {
		return A2(
			...
			_default,
			$elm_community$maybe_extra$Maybe$Extra$join(
				A2($elm_community$list_extra$List$Extra$getAt, index, match.bC)));
	});
	...
	function (msg, model) {
		...
		while (true) {
			switch (msg.$) {
				...
				case 13:
					var value = msg.a;
					return model.aj ? $author$project$AonTool$updateCandidates(
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
				...
				case 14:
					...
					if (!result.$) {
						...
						return ((_Utils_cmp(
							...
							$elm$core$Maybe$Just(searchResult.aI)))(
							_Utils_Tuple2(
								_Utils_update(
									model,
									{
				...
				case 30:
					var text = msg.a;
					return model.af ? _Utils_Tuple2(model, $elm$core$Platform$Cmd$none) : _Utils_Tuple2(
						_Utils_update(
							model,
							{
								F: model.F + 1,
				...
				case 32:
					...
					if (!_v17.$) {
						...
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{af: true, k: undo.k, c: undo.c, r: $elm$core$Maybe$Nothing}),
					...
					_List_fromArray(
						[
							...
							A3(
								$elm$core$String$slice,
								candidate.i,
								candidate.i + $elm$core$String$length(candidate.m.g),
								model.c)),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A3(
										$elm$core$String$slice,
										candidate.i + $elm$core$String$length(candidate.m.g),
										(candidate.i + $elm$core$String$length(candidate.m.g)) + 10,
										model.c)),
									(_Utils_cmp(
									(candidate.i + $elm$core$String$length(candidate.m.g)) + 10,
					...
					_List_fromArray(
						[
							...
							A2($author$project$AonTool$isCandidateInATag, candidate, model.c) || A2(
								$elm$core$String$contains,
								$author$project$AonTool$getDocumentLink(candidate.m),
								model.c)),
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(candidate.m.g),
									A2(
									$elm$html$Html$a,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href(
											_Utils_ap(model.J, candidate.m.V)),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(candidate.m.V)
										]))
								])),
							A2(
							$elm$html$Html$div,
...
var $author$project$AonTool$CopyFirstSentenceToClipboardPressed = {$: 8};
var $author$project$AonTool$CopyToClipboardPressed = {$: 7};
var $author$project$AonTool$PasteFromClipboardPressed = {$: 24};
...
var $author$project$AonTool$RefreshDataPressed = {$: 26};
	...
	function (model, text) {
		if (_Utils_eq(model.d.l, model.d.t)) {
			...
			var _v0 = function () {
				...
				if (!_v1.$) {
					var candidate = _v1.a;
					var candidateEnd = candidate.i + $elm$core$String$length(candidate.m.g);
					return _Utils_Tuple2(
						model.d.l,
				...
				A2(
					...
					_List_fromArray(
						[
							...
							$author$project$AonTool$regexFromString('<.+?>'),
							function (match) {
								return '</highlight-selection>' + (match.cf + '<highlight-selection>');
							},
...
var $author$project$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.cq) + ('\n' + $author$project$Markdown$Parser$problemToString(deadEnd.cn)));
};
...
var $author$project$Markdown$Renderer$defaultHtmlRenderer = {
	aP: $elm$html$Html$blockquote(_List_Nil),
	aS: function (_v0) {
		var body = _v0.bY;
		var language = _v0.cd;
	...
	aW: function (children) {
		return A2($elm$html$Html$em, _List_Nil, children);
	},
	a2: A2($elm$html$Html$br, _List_Nil, _List_Nil),
	a3: function (_v3) {
		var level = _v3.bc;
		var children = _v3.aR;
		switch (level) {
	...
	b7: $author$project$Markdown$Html$oneOf(_List_Nil),
	a8: function (imageInfo) {
		var _v5 = imageInfo.cw;
		if (!_v5.$) {
			var title = _v5.a;
			return A2(
				$elm$html$Html$img,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(imageInfo.ay),
						$elm$html$Html$Attributes$alt(imageInfo.ap),
		...
		function (link, content) {
			...
			if (!_v6.$) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(link.b0),
							$elm$html$Html$Attributes$title(title)
						]),
					content);
			} else {
	...
	bh: $elm$html$Html$p(_List_Nil),
	bA: function (children) {
		return A2($elm$html$Html$del, _List_Nil, children);
	},
	bB: function (children) {
		return A2($elm$html$Html$strong, _List_Nil, children);
	},
	bE: $elm$html$Html$table(_List_Nil),
	bF: $elm$html$Html$tbody(_List_Nil),
	bG: function (maybeAlignment) {
		var attrs = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
	...
	bH: $elm$html$Html$thead(_List_Nil),
	bI: function (maybeAlignment) {
		var attrs = A2(
			$elm$core$Maybe$withDefault,
			_List_Nil,
			A2(
	...
	bJ: $elm$html$Html$tr(_List_Nil),
	c: $elm$html$Html$text,
	bL: A2($elm$html$Html$hr, _List_Nil, _List_Nil),
	bP: function (items) {
		return A2(
			$elm$html$Html$ul,
			_List_Nil,
...
var $author$project$AonTool$markdownRenderer = function (model) {
	...
	return {
		aP: A2(
			...
			A2($elm$core$Basics$composeR, defaultRenderer.aP, $elm$core$List$singleton)),
		aS: A2($elm$core$Basics$composeR, defaultRenderer.aS, $elm$core$List$singleton),
		aT: A2($elm$core$Basics$composeR, defaultRenderer.aT, $elm$core$List$singleton),
		aW: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.aW, $elm$core$List$singleton)),
		a2: $elm$core$List$singleton(defaultRenderer.a2),
		a3: function (heading) {
			return _List_fromArray(
				[
					defaultRenderer.a3(
					{
						aR: $elm$core$List$concat(heading.aR),
						bc: heading.bc,
						bq: heading.bq
					})
				]);
		},
		b7: $author$project$AonTool$markdownHtmlRenderer(model),
		a8: A2($elm$core$Basics$composeR, defaultRenderer.a8, $elm$core$List$singleton),
		ca: $elm$core$List$concat,
		bd: function (linkData) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.bd(linkData),
					$elm$core$List$singleton));
		},
		bg: function (startingIndex) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.bg(startingIndex),
					$elm$core$List$singleton));
		},
		bh: A2(
			$elm$core$Basics$composeR,
		...
		bA: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bA, $elm$core$List$singleton)),
		bB: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
		...
		bE: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bE, $elm$core$List$singleton)),
		bF: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bF, $elm$core$List$singleton)),
		bG: function (alignment) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.bG(alignment),
					$elm$core$List$singleton));
		},
		bH: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bH, $elm$core$List$singleton)),
		bI: function (alignment) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.bI(alignment),
					$elm$core$List$singleton));
		},
		bJ: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bJ, $elm$core$List$singleton)),
		c: A2($elm$core$Basics$composeR, defaultRenderer.c, $elm$core$List$singleton),
		bL: $elm$core$List$singleton(defaultRenderer.bL),
		bP: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(
				function (item) {
			...
			A2($elm$core$Basics$composeR, defaultRenderer.bP, $elm$core$List$singleton))
	};
};
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.ay);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.e, offset) < 0,
					0,
					{aU: col, h: s0.h, j: s0.j, e: offset, cq: row, ay: s0.ay});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.e, s.cq, s.aU, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aU: col, b$: contextStack, cn: problem, cq: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cq, s.aU, x, s.h));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.e, s.cq, s.aU, s.ay);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aU: newCol, h: s.h, j: s.j, e: newOffset, cq: newRow, ay: s.ay});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.e, s1.e, s0.ay),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.e, s.ay);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{aU: 1, h: s.h, j: s.j, e: s.e + 1, cq: s.cq + 1, ay: s.ay}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aU: s.aU + 1, h: s.h, j: s.j, e: newOffset, cq: s.cq, ay: s.ay}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.e, s.cq, s.aU, s.ay);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.ay) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.e, adjustedOffset) < 0,
			0,
			{aU: newCol, h: s.h, j: s.j, e: adjustedOffset, cq: newRow, ay: s.ay});
	};
};
...
var $author$project$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {bY: body, cb: intended, ce: marker, cm: order};
	});
var $elm$parser$Parser$Advanced$getCol = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.aU, s);
};
...
var $author$project$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($author$project$Markdown$RawBlock$OrderedListBlock, true, item.cb, item.ce, item.cm, _List_Nil, item.bY);
		},
...
var $author$project$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {t: childMatch.t - parentMatch.w, u: childMatch.u, l: childMatch.l - parentMatch.w, c: childMatch.c, C: childMatch.C - parentMatch.w, w: childMatch.w - parentMatch.w, n: childMatch.n};
	});
...
var $author$project$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		C: 0,
		w: 0,
		n: $author$project$Markdown$InlineParser$NormalType
	};
};
...
var $author$project$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{i: regMatch.i + backslashesLength, aE: 1, f: $author$project$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$author$project$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{i: (regMatch.i + backslashesLength) - 1, aE: 2, f: $author$project$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							i: regMatch.i,
							aE: $elm$core$String$length(regMatch.cf),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{i: regMatch.i + backslashesLength, aE: 1, f: $author$project$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{i: (regMatch.i + backslashesLength) - 1, aE: 2, f: $author$project$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $author$project$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{i: regMatch.i + backslashesLength, aE: 1, f: $author$project$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{i: index, aE: 2, f: $author$project$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						i: index,
...
var $author$project$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{i: regMatch.i + backslashesLength, aE: length, f: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	...
	return A2($elm$regex$Regex$contains, $author$project$Markdown$InlineParser$urlRegex, match.c) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				n: $author$project$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.c,
	...
	function (matchModel, references, maybeRegexMatch) {
		...
		if (_v0.$ === 1) {
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{t: matchModel.t + regexMatchLength, n: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						t: matchModel.t + $elm$core$String$length(regexMatch.cf),
						n: function () {
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aU: 1, h: _List_Nil, j: 1, e: 0, cq: 1, ay: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {a7: htmlTag, aE: endOffset - startOffset};
							})),
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.av, open.ax) || _Utils_eq(close.av, close.ax)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.aE + openToken.aE))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.aE)) && (!A2($elm$core$Basics$modBy, 3, openToken.aE)))) : true) : false;
			} else {
				return false;
			}
		} else {
...
var $author$project$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {t: token.i + token.aE, u: _List_Nil, l: token.i, c: '', C: 0, w: 0, n: type_};
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{i: openToken.i + 1, aE: openToken.aE - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v27.$ === 7) {
					var _char = _v27.a;
					var leftFringeRank = _v27.b.av;
					var rightFringeRank = _v27.b.ax;
...
var $author$project$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var updt = (!remainLength) ? {at: closeToken, ai: openToken, aw: remainTokens, aA: tokensTail} : ((remainLength > 0) ? {
			at: closeToken,
			ai: _Utils_update(
				openToken,
				{i: openToken.i + remainLength, aE: closeToken.aE}),
			aw: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			aA: A2(
				...
				_Utils_update(
					closeToken,
					{i: closeToken.i + openToken.aE, aE: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$author$project$Markdown$InlineParser$tokenPairToMatch,
			...
			$author$project$Markdown$InlineParser$EmphasisType(updt.ai.aE),
			updt.ai,
			updt.at,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.aA, match, updt.aw);
	});
...
var $author$project$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.i + openToken.aE;
		var textEnd = closeToken.i;
		var text = processText(
			A3($elm$core$String$slice, textStart, textEnd, rawText));
		var start = openToken.i;
		var end = closeToken.i + closeToken.aE;
		var match = {t: end, u: _List_Nil, l: start, c: text, C: textEnd, w: textStart, n: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {t: end, u: matches, l: start, c: text, C: textEnd, w: textStart, n: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {ao: alignment, ab: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $author$project$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $author$project$Markdown$CodeBlock$backtick = {ar: '`', au: 0, az: $author$project$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		...
		return A2(
			...
			A2(
				...
				builtTokens,
				$elm$parser$Parser$Advanced$chompWhile(
					$elm$core$Basics$eq(fenceCharacter.ar))));
	});
...
var $author$project$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $author$project$Markdown$CodeBlock$tilde = {ar: '~', au: 1, az: $author$project$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {as: character, aD: indent, aE: length};
					})),
...
var $elm$parser$Parser$Advanced$getSource = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.ay, s);
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($author$project$Markdown$CodeBlock$closingFence, fence.aE, fence.as))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$author$project$Markdown$CodeBlock$codeBlockLine(fence.aD)),
					$elm$parser$Parser$Advanced$getOffset),
	...
	function (fence) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$author$project$Markdown$CodeBlock$infoString(fence.as),
					$author$project$Helpers$lineEndOrEnd)),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.e, s.cq, s.aU, s.ay);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {aU: col, h: context, cq: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {aU: s.aU, h: newContext, j: s.j, e: s.e, cq: s.cq, ay: s.ay};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.cq, s0.aU, context),
						s0.h),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		F2(
			function (delimiterText, revDelimiterColumns) {
				return A2(
					...
					{
						bp: delimiterText,
						bO: $elm$core$String$trim(delimiterText)
					},
					A2(
						$elm$core$List$map,
		...
		function (listmarker, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {bY: body, ce: listmarker, o: $elm$core$Maybe$Nothing};
				default:
					return {bY: '', ce: listmarker, o: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$author$project$Markdown$RawBlock$CodeBlock(
											{
												bY: A2($author$project$Markdown$Parser$joinStringsPreserveAll, block2.bY, block1.bY),
					...
					case 3:
						...
						switch (newRawBlock.$) {
							case 3:
								...
								if (_Utils_eq(openListItem2.ce, openListItem1.ce)) {
									var _v59 = A2(
										$elm$parser$Parser$Advanced$run,
										$author$project$Markdown$Parser$cyclic$rawBlockParser(),
										openListItem2.bY);
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														bY: A3($author$project$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.bY, body1)
													})),
											rest)
									});
							default:
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.o, item.bY);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$CodeBlock(
						{bY: codeBlockBody, cd: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$Paragraph(
						A2($author$project$Markdown$Parser$inlineParseHelper, linkReferences, text.bp)));
			default:
				var raw = rawBlock.b;
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	bY: A3($author$project$Markdown$Parser$joinRawStringsWith, '', openListItem.bY, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.bY) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
	...
	return function (block) {
		switch (block.$) {
							...
							return renderer.a3(
								{
									aR: children,
									bc: level,
									bq: $author$project$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 8:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.aS(codeBlock)));
			case 9:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.bL));
			case 3:
								...
								renderer.bJ(
									A2(
										...
										function (_v10) {
											...
											var item = _v10.b;
											return A2(renderer.bI, maybeAlignment, item);
										},
										listListView))));
					},
					renderedHeaderCells);
...
var $author$project$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.a8(
							{
								ap: $author$project$Markdown$Block$extractInlineText(children),
								ay: src,
								cw: title
							})));
			case 7:
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.a2));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
...
var $author$project$AonTool$CopyRowToClipboardPressed = {$: 6};
var $author$project$AonTool$CriticalEffects = 2;
var $author$project$AonTool$Feats = 3;
var $author$project$AonTool$ParseActionPressed = {$: 17};
var $author$project$AonTool$ParseAnimalCompanionsPressed = {$: 18};
var $author$project$AonTool$ParseCritEffectsPressed = {$: 19};
var $author$project$AonTool$ParseFeatHeadersPressed = {$: 20};
var $author$project$AonTool$ParseRitualHeadersPressed = {$: 21};
var $author$project$AonTool$ParseSpellHeadersPressed = {$: 22};
var $author$project$AonTool$ParseTreasureHeadersPressed = {$: 23};
...
var $author$project$AonTool$FormatTraitsPressed = {$: 12};
...
var $author$project$AonTool$main = $elm$browser$Browser$element(
	{b9: $author$project$AonTool$init, cu: $author$project$AonTool$subscriptions, cy: $author$project$AonTool$update, cz: $author$project$AonTool$view});
