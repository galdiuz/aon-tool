				...
				A2(
					...
					function (document) {
						return A2(
							...
							document.C,
							_List_fromArray(
								['action-1167', 'creature-1969', 'rules-33', 'rules-90', 'rules-2040', 'rules-2882', 'rules-2586', 'rules-2559', 'rules-165', 'rules-2271']))) && (!((document.S === 'rules') && A2(
							$elm$core$List$member,
							document.i,
							_List_fromArray(
											...
											A2(
												...
												_List_fromArray(
													[
														...
														A3($author$project$AonTool$getSubmatch, 11, 'NULL', match),
														'NULL',
														'0',
														'0',
														'NULL',
														...
														A3($author$project$AonTool$getSubmatch, 7, 'NULL', match),
														'NULL',
														'NULL',
														'1',
														'NULL',
