...
{
	if (region.J._ === region.U._)
	{
		return 'on line ' + region.J._;
	}
	return 'on lines ' + region.J._ + ' through ' + region.U._;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { b_: 'hidden', bS: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { b_: 'mozHidden', bS: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { b_: 'msHidden', bS: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { b_: 'webkitHidden', bS: 'webkitvisibilitychange' }
		: { b_: 'hidden', bS: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.b6, request.L, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {aU: fragment, aZ: host, ba: path, bc: port_, bf: protocol, bg: query};
	});
...
var $author$project$AonTool$defaultFlags = {aa: $elm$core$Dict$empty};
var $author$project$AonTool$emptySelection = {U: 0, J: 0, c: ''};
																...
																$elm$json$Json$Encode$object(
																	_List_fromArray(
																		[
																			_Utils_Tuple2(
																			'query',
																			$elm$json$Json$Encode$string('!category:(category-page OR class-feature) !remaster_id:*')),
																			_Utils_Tuple2(
																			'default_operator',
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bO: false, bQ: r.bQ, bX: r.bX, bZ: r.bZ, b6: r.b6, cl: r.cl, cn: r.cn, L: r.L}));
};
				...
				_List_fromArray(
					[
						...
						$elm$http$Http$request(
						{
							...
							bX: A2($elm$http$Http$expectJson, $author$project$AonTool$GotDataResult, $author$project$AonTool$esResultDecoder),
							bZ: _List_Nil,
							b6: 'POST',
							cl: $elm$core$Maybe$Just(10000),
							cn: $elm$core$Maybe$Nothing,
							L: model.Z + '/_search?track_total_hits=true'
						})
					])));
	});
...
var $author$project$AonTool$flagsDecoder = A3(
	...
	function (localStorage) {
		return $elm$json$Json$Decode$succeed(
			{
				aa: A2($elm$core$Maybe$withDefault, $author$project$AonTool$defaultFlags.aa, localStorage)
			});
	});
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {h: index, ab: match, b8: number, bu: submatches};
	});
...
var $author$project$AonTool$updateCandidates = function (_v0) {
	...
	var candidates = A2(
		...
		F2(
			function (a, b) {
				var _v1 = A2($elm$core$Basics$compare, a.h, b.h);
				switch (_v1) {
					case 0:
						return 0;
					case 1:
						return A2(
							...
							$elm$core$String$length(b.k.i),
							$elm$core$String$length(a.k.i));
					default:
						return 2;
				}
			}),
		A2(
			...
			function (candidate) {
				return (model.s.c !== '') ? ((_Utils_cmp(candidate.h, model.s.J) > -1) && (_Utils_cmp(candidate.h, model.s.U) < 0)) : true;
			},
			A2(
				...
				function (document) {
					return A2(
						$elm$core$List$map,
						function (match) {
							return {k: document, h: match.h};
						},
						A2(
							$elm$regex$Regex$find,
							$author$project$AonTool$regexFromString(
								'(?<![a-zA-Z%])' + ($author$project$AonTool$escapeRegex(document.i) + '(?![a-zA-Z%])')),
							model.c));
				},
				A2(
					$elm$core$List$filter,
					function (document) {
						return A2(
							...
							$elm$core$String$toLower(document.i),
							$elm$core$String$toLower(model.c)) && ((!A2(
							$elm$core$List$member,
							document.C,
							_List_fromArray(
								['action-1167', 'creature-1969', 'rules-33', 'rules-90', 'rules-2040', 'rules-2882', 'rules-2586', 'rules-2559', 'rules-165', 'rules-2271', 'rules-2188']))) && (!((document.S === 'rules') && A2(
							$elm$core$List$member,
							document.i,
							_List_fromArray(
	...
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{aj: candidates, N: $elm$core$Maybe$Nothing}),
		cmd);
};
		...
		_Utils_Tuple2(
			function (model) {
				return A3(
					...
					model,
					$elm$core$Dict$toList(flags.aa));
			}(
				{M: 'https://2e.aonprd.com', aj: _List_Nil, N: $elm$core$Maybe$Nothing, x: 0, t: _List_Nil, Z: 'https://elasticsearch.aonprd.com/aon', A: '', s: $author$project$AonTool$emptySelection, c: ''}),
...
var $author$project$AonTool$selectionChanged = _Platform_incomingPort('selectionChanged', $elm$json$Json$Decode$value);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$AonTool$selectionChanged($author$project$AonTool$SelectionChanged)
			]));
};
...
var $author$project$AonTool$addLinkTag = F2(
	function (document, string) {
		return (document.S === 'spell') ? ($author$project$AonTool$getDocumentLink(document) + ('<i>' + (string + '</i><%END>'))) : ($author$project$AonTool$getDocumentLink(document) + (string + '<%END>'));
	});
...
var $author$project$AonTool$applyCandidate = F2(
	function (candidate, text) {
		var endIndex = candidate.h + $elm$core$String$length(candidate.k.i);
		return A4(
			$elm_community$string_extra$String$Extra$replaceSlice,
			A2(
				$author$project$AonTool$addLinkTag,
				candidate.k,
				A3($elm$core$String$slice, candidate.h, endIndex, text)),
			candidate.h,
			endIndex,
			text);
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'_id',
				$elm$json$Json$Encode$string(document.C)),
				_Utils_Tuple2(
				'_source',
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'category',
							$elm$json$Json$Encode$string(document.S)),
							_Utils_Tuple2(
							'name',
							$elm$json$Json$Encode$string(document.i)),
							_Utils_Tuple2(
							'url',
							$elm$json$Json$Encode$string(document.L))
						])))
			]));
};
...
var $author$project$AonTool$getSubmatch = F3(
	function (index, _default, match) {
		return A2(
			...
			_default,
			$elm_community$maybe_extra$Maybe$Extra$join(
				A2($elm_community$list_extra$List$Extra$getAt, index, match.bu)));
	});
			...
			function (start) {
				return A3(
					...
					function (end) {
						return $elm$json$Json$Decode$succeed(
							{
								U: end - $elm$core$List$length(
									A2(
										$elm_community$list_extra$List$Extra$takeWhile,
										$elm$core$Basics$eq(' '),
										$elm$core$List$reverse(
											$elm$core$String$toList(text)))),
								J: start + $elm$core$List$length(
									A2(
										$elm_community$list_extra$List$Extra$takeWhile,
										$elm$core$Basics$eq(' '),
										$elm$core$String$toList(text))),
...
var $author$project$AonTool$update = F2(
	function (msg, model) {
		switch (msg.$) {
				...
				return $author$project$AonTool$updateCandidates(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: A3($elm_community$string_extra$String$Extra$insertAt, '<br />', model.s.J, model.c)
							}),
						$elm$core$Platform$Cmd$none));
			case 1:
				var value = msg.a;
				...
				return $author$project$AonTool$updateCandidates(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: A2($author$project$AonTool$applyCandidate, candidate, model.c)
							}),
						$elm$core$Platform$Cmd$none));
			case 3:
				var candidate = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							N: $elm$core$Maybe$Just(candidate)
						}),
					$elm$core$Platform$Cmd$none);
			case 4:
				return _Utils_Tuple2(
			...
			case 8:
				var debounce = msg.a;
				return _Utils_eq(model.x, debounce) ? $author$project$AonTool$updateCandidates(
					...
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: A3(
									$elm$regex$Regex$replace,
									$author$project$AonTool$regexFromString('(?:Activate—)?(.*) (\\[.*\\]) (\\(.*\\))? ?(?:Trigger (.*?(?=;)); )?(?:Frequency (.*?(?=;)); )?(?:Requirements (.*?(?=;)); )?(?:Effect (.*))'),
									function (match) {
										return A2(
											$elm$core$String$join,
											'\t',
											A2(
												...
												_List_fromArray(
													[
														...
														A3($author$project$AonTool$getSubmatch, 2, 'NULL', match),
														A3($author$project$AonTool$getSubmatch, 0, 'NULL', match),
														'NULL',
														'NULL',
														'NULL',
														'NULL',
														$author$project$AonTool$actionIdFromString(
														A3($author$project$AonTool$getSubmatch, 1, 'NULL', match)),
														A3($author$project$AonTool$getSubmatch, 6, 'NULL', match),
														'NULL',
														'0',
														'0',
														'NULL',
														A3($author$project$AonTool$getSubmatch, 3, 'NULL', match),
														A3($author$project$AonTool$getSubmatch, 5, 'NULL', match),
														A3($author$project$AonTool$getSubmatch, 4, 'NULL', match),
														'NULL',
														'NULL',
														'1',
														'NULL',
					...
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: A3(
									$elm$regex$Regex$replace,
									$author$project$AonTool$regexFromString('^.*?(Critical Success (.*?(?=Success)|$))?(Success (.*?((?=Failure)|$)))?(Failure (.*?((?=Critical Failure)|$)))?(Critical Failure (.*))?$'),
									function (match) {
										return A2(
											$elm$core$String$join,
											'\t',
											A2(
												...
												_List_fromArray(
													[
														...
														A3($author$project$AonTool$getSubmatch, 3, 'NULL', match),
														A3($author$project$AonTool$getSubmatch, 6, 'NULL', match),
														A3($author$project$AonTool$getSubmatch, 9, 'NULL', match)
													])));
									},
									$elm_community$string_extra$String$Extra$clean(
										A3(
				...
				return $author$project$AonTool$updateCandidates(
					_Utils_Tuple2(
						_Utils_update(
							...
							{
								A: '',
								s: $author$project$AonTool$emptySelection,
			...
			case 14:
				...
				if (!result.$) {
					...
					return ((_Utils_cmp(
						$elm$core$List$length(searchResult.t),
						$author$project$AonTool$dataSize) < 0) ? function (_v3) {
						var m = _v3.a;
						var cmd = _v3.b;
						return _Utils_Tuple2(
							m,
							A2(
								...
								A2(
									...
									0,
									A2($elm$json$Json$Encode$list, $author$project$AonTool$encodeDocument, m.t))));
					} : $author$project$AonTool$fetchData(
						$elm$core$Maybe$Just(searchResult.aA)))(
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
									t: A2($elm$core$List$append, model.t, searchResult.t)
								}),
							$elm$core$Platform$Cmd$none));
				} else {
			...
			case 15:
				...
				return _Utils_Tuple2(
					...
					A2(
						...
						function (_v4) {
							return $author$project$AonTool$DebouncePassed(model.x + 1);
						},
						...
						_Utils_update(
							model,
							{
								c: A3(
									...
									start,
									model.s.J,
									A3($elm_community$string_extra$String$Extra$insertAt, end, model.s.U, model.c))
							}),
						$elm$core$Platform$Cmd$none));
		}
	});
...
var $author$project$AonTool$ConvertActionsPressed = {$: 4};
var $author$project$AonTool$ConvertToListPressed = {$: 5};
var $author$project$AonTool$CopyFirstSentenceToClipboardPressed = {$: 7};
var $author$project$AonTool$CopyToClipboardPressed = {$: 6};
var $author$project$AonTool$ElasticUrlChanged = function (a) {
	return {$: 9, a: a};
};
var $author$project$AonTool$FixNewlinesPressed = {$: 10};
var $author$project$AonTool$FormatActionPressed = {$: 11};
var $author$project$AonTool$FormatCritEffectsPressed = {$: 12};
var $author$project$AonTool$PasteFromClipboardPressed = {$: 16};
var $author$project$AonTool$RefreshDataPressed = {$: 17};
...
var $author$project$AonTool$isCandidateInATag = F2(
	function (candidate, rawText) {
		var text = A3(
			$elm$regex$Regex$replace,
			$author$project$AonTool$regexFromString('<%ACTION(S|.TYPES)#(.+?)%%>'),
			function (match) {
				return '';
			},
			rawText);
		...
		var openIndicesBefore = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (i) {
					return _Utils_cmp(i, candidate.h) < 0;
				},
				openIndices));
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									(candidate.h < 10) ? $elm$html$Html$text('') : $elm$html$Html$text('...'),
									$elm$html$Html$text(
									A3(
										$elm$core$String$slice,
										A2($elm$core$Basics$max, 0, candidate.h - 10),
										candidate.h,
										model.c))
								])),
							$elm$html$Html$text(
							A3(
								$elm$core$String$slice,
								candidate.h,
								candidate.h + $elm$core$String$length(candidate.k.i),
								model.c)),
							A2(
							$elm$html$Html$span,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									A3(
										$elm$core$String$slice,
										candidate.h + $elm$core$String$length(candidate.k.i),
										(candidate.h + $elm$core$String$length(candidate.k.i)) + 10,
										model.c)),
									(_Utils_cmp(
									(candidate.h + $elm$core$String$length(candidate.k.i)) + 10,
					...
					_List_fromArray(
						[
							...
							A2($author$project$AonTool$isCandidateInATag, candidate, model.c) || A2(
								$elm$core$String$contains,
								$author$project$AonTool$getDocumentLink(candidate.k),
								model.c)),
					...
					_List_fromArray(
						[
							...
							$elm$core$String$contains,
							$author$project$AonTool$getDocumentLink(candidate.k),
							model.c) ? $elm$html$Html$text('Applied') : (A2($author$project$AonTool$isCandidateInATag, candidate, model.c) ? $elm$html$Html$text('Already in a tag') : $elm$html$Html$text('Apply'))
						]))
				]));
	});
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(candidate.k.i),
									A2(
									$elm$html$Html$a,
									_List_fromArray(
										[
											$elm$html$Html$Attributes$href(
											_Utils_ap(model.M, candidate.k.L)),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(candidate.k.L)
										]))
								])),
							A2(
							$elm$html$Html$div,
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(document.i),
											A2(
											$elm$html$Html$a,
											_List_fromArray(
												[
													$elm$html$Html$Attributes$href(
													_Utils_ap(model.M, document.L)),
													$elm$html$Html$Attributes$target('_blank')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(document.L)
												]))
										])),
									A2(
									$elm$html$Html$button,
					...
					A2(
						...
						A2(
							...
							F2(
								function (a, b) {
									return (_Utils_eq(
										$elm$core$String$toLower(a.i),
										$elm$core$String$toLower(model.A)) && _Utils_eq(
										$elm$core$String$toLower(b.i),
										$elm$core$String$toLower(model.A))) ? A2($elm$core$Basics$compare, a.C, b.C) : (_Utils_eq(
										$elm$core$String$toLower(a.i),
										$elm$core$String$toLower(model.A)) ? 0 : (_Utils_eq(
										$elm$core$String$toLower(b.i),
										$elm$core$String$toLower(model.A)) ? 2 : A2($elm$core$Basics$compare, a.C, b.C)));
								}),
							A2(
								$elm$core$List$filter,
								function (document) {
...
var $author$project$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.cg) + ('\n' + $author$project$Markdown$Parser$problemToString(deadEnd.cd)));
};
...
var $author$project$Markdown$Renderer$defaultHtmlRenderer = {
	aG: $elm$html$Html$blockquote(_List_Nil),
	aJ: function (_v0) {
		var body = _v0.bQ;
		var language = _v0.b4;
	...
	aN: function (children) {
		return A2($elm$html$Html$em, _List_Nil, children);
	},
	aV: A2($elm$html$Html$br, _List_Nil, _List_Nil),
	aW: function (_v3) {
		var level = _v3.a4;
		var children = _v3.aI;
		switch (level) {
	...
	b$: $author$project$Markdown$Html$oneOf(_List_Nil),
	a$: function (imageInfo) {
		...
		if (!_v5.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(imageInfo.ar),
						$elm$html$Html$Attributes$alt(imageInfo.ai),
		...
		function (link, content) {
			...
			if (!_v6.$) {
				...
				return A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$href(link.bU),
							$elm$html$Html$Attributes$title(title)
						]),
					content);
			} else {
	...
	a9: $elm$html$Html$p(_List_Nil),
	bs: function (children) {
	...
	bB: $elm$html$Html$tr(_List_Nil),
	c: $elm$html$Html$text,
	bD: A2($elm$html$Html$hr, _List_Nil, _List_Nil),
	bH: function (items) {
		return A2(
			$elm$html$Html$ul,
			_List_Nil,
				...
				function (children) {
					return _List_fromArray(
						[
							...
							_List_fromArray(
								[
									A2($elm$html$Html$Attributes$style, 'color', '#ff00ff')
								]),
							$elm$core$List$concat(children))
						]);
				}),
...
var $author$project$AonTool$markdownRenderer = function (model) {
	...
	return {
		aG: A2(
			...
			A2($elm$core$Basics$composeR, defaultRenderer.aG, $elm$core$List$singleton)),
		aJ: A2($elm$core$Basics$composeR, defaultRenderer.aJ, $elm$core$List$singleton),
		aK: A2($elm$core$Basics$composeR, defaultRenderer.aK, $elm$core$List$singleton),
		aN: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.aN, $elm$core$List$singleton)),
		aV: $elm$core$List$singleton(defaultRenderer.aV),
		aW: function (heading) {
			return _List_fromArray(
				[
					defaultRenderer.aW(
					{
						aI: $elm$core$List$concat(heading.aI),
						a4: heading.a4,
						bi: heading.bi
					})
				]);
		},
		b$: $author$project$AonTool$markdownHtmlRenderer(model),
		a$: A2($elm$core$Basics$composeR, defaultRenderer.a$, $elm$core$List$singleton),
		a5: function (linkData) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.a5(linkData),
					$elm$core$List$singleton));
		},
		a8: function (startingIndex) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.a8(startingIndex),
					$elm$core$List$singleton));
		},
		a9: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.a9, $elm$core$List$singleton)),
		bs: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bs, $elm$core$List$singleton)),
		bt: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bt, $elm$core$List$singleton)),
		bw: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bw, $elm$core$List$singleton)),
		bx: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bx, $elm$core$List$singleton)),
		by: function (alignment) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.by(alignment),
					$elm$core$List$singleton));
		},
		bz: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$concat,
			A2($elm$core$Basics$composeR, defaultRenderer.bz, $elm$core$List$singleton)),
		bA: function (alignment) {
			return A2(
				$elm$core$Basics$composeR,
				$elm$core$List$concat,
				A2(
					$elm$core$Basics$composeR,
					defaultRenderer.bA(alignment),
					$elm$core$List$singleton));
		},
		bB: A2(
			$elm$core$Basics$composeR,
		...
		bD: $elm$core$List$singleton(defaultRenderer.bD),
		bH: A2(
			$elm$core$Basics$composeR,
			$elm$core$List$map(
				function (item) {
			...
			A2($elm$core$Basics$composeR, defaultRenderer.bH, $elm$core$List$singleton))
	};
};
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.ar);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.d, offset) < 0,
					0,
					{aL: col, f: s0.f, g: s0.g, d: offset, cg: row, ar: s0.ar});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.d, s.cg, s.aL, s);
	};
};
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aL: col, bT: contextStack, cd: problem, cg: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cg, s.aL, x, s.f));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.cg, s.aL, s.ar);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aL: newCol, f: s.f, g: s.g, d: newOffset, cg: newRow, ar: s.ar});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.d, s1.d, s0.ar),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.d, s.ar);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{aL: 1, f: s.f, g: s.g, d: s.d + 1, cg: s.cg + 1, ar: s.ar}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aL: s.aL + 1, f: s.f, g: s.g, d: newOffset, cg: s.cg, ar: s.ar}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.d, s.cg, s.aL, s.ar);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.ar) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.d, adjustedOffset) < 0,
			0,
			{aL: newCol, f: s.f, g: s.g, d: adjustedOffset, cg: newRow, ar: s.ar});
	};
};
...
var $author$project$Markdown$OrderedList$ListItem = F4(
	function (order, intended, marker, body) {
		return {bQ: body, b2: intended, b5: marker, cc: order};
	});
var $elm$parser$Parser$Advanced$getCol = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.aL, s);
};
...
var $author$project$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($author$project$Markdown$RawBlock$OrderedListBlock, true, item.b2, item.b5, item.cc, _List_Nil, item.bQ);
		},
	...
	switch (_v1.$) {
		...
		case 4:
			...
			return A3(
				...
				url,
				maybeTitle,
				$author$project$Markdown$InlineParser$matchesToInlines(match.p));
		case 5:
			var _v4 = _v1.a;
			var url = _v4.a;
...
var $author$project$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {U: childMatch.U - parentMatch.r, p: childMatch.p, J: childMatch.J - parentMatch.r, c: childMatch.c, w: childMatch.w - parentMatch.r, r: childMatch.r - parentMatch.r, j: childMatch.j};
	});
...
var $author$project$Markdown$InlineParser$organizeChildren = function (_v4) {
	...
	return {
		U: match.U,
		p: $author$project$Markdown$InlineParser$organizeMatches(match.p),
		J: match.J,
		c: match.c,
		w: match.w,
		r: match.r,
	...
	function (remaining, _v0, matchesTail) {
		...
		while (true) {
			...
			if (!remaining.b) {
				...
				if (_Utils_cmp(prevMatch.U, match.J) < 1) {
					...
					if ((_Utils_cmp(prevMatch.J, match.J) < 0) && (_Utils_cmp(prevMatch.U, match.U) > 0)) {
						var $temp$remaining = rest,
...
var $author$project$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		w: 0,
		r: 0,
		j: $author$project$Markdown$InlineParser$NormalType
	};
};
var $author$project$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			U: matchModel.U,
			p: A3($author$project$Markdown$InlineParser$parseTextMatches, matchModel.c, _List_Nil, matchModel.p),
			J: matchModel.J,
			c: matchModel.c,
			w: matchModel.w,
			r: matchModel.r,
		...
		if (!parsedMatches.b) {
			...
			if (!_v4.$) {
				...
				return _Utils_eq(matchModel.U, matchHead.J) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.U, matchHead.J) < 0) ? A2(
					$elm$core$List$cons,
					updtMatch,
					A2(
						$elm$core$List$cons,
						$author$project$Markdown$InlineParser$normalMatch(
							A3($elm$core$String$slice, matchModel.U, matchHead.J, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.J > 0) ? A2(
						$elm$core$List$cons,
						$author$project$Markdown$InlineParser$normalMatch(
							A2($elm$core$String$left, matchModel.J, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
...
var $author$project$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, aw: 1, e: $author$project$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
		...
		return $elm$core$Maybe$Just(
			{
				...
				aw: 1,
				e: $author$project$Markdown$Helpers$isEven(backslashesLength) ? $author$project$Markdown$InlineParser$AngleBracketClose(1) : $author$project$Markdown$InlineParser$AngleBracketClose(0)
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
		...
		return $elm$core$Maybe$Just(
			{
				...
				e: $author$project$Markdown$Helpers$isEven(backslashesLength) ? $author$project$Markdown$InlineParser$CodeToken(1) : $author$project$Markdown$InlineParser$CodeToken(0)
			});
	} else {
		return $elm$core$Maybe$Nothing;
	}
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$author$project$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{h: (regMatch.h + backslashesLength) - 1, aw: 2, e: $author$project$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							h: regMatch.h,
							aw: $elm$core$String$length(regMatch.ab),
							e: $author$project$Markdown$InlineParser$HardLineBreakToken
						});
				} else {
					break _v0$2;
				}
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{h: regMatch.h + backslashesLength, aw: 1, e: $author$project$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{h: (regMatch.h + backslashesLength) - 1, aw: 2, e: $author$project$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $author$project$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $author$project$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, aw: 1, e: $author$project$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
				...
				return $elm$core$Maybe$Just(
					{
						h: index,
						aw: 1,
						e: $author$project$Markdown$InlineParser$LinkOpenToken(0)
					});
			} else {
				return $elm$core$Maybe$Nothing;
			}
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{h: index, aw: 2, e: $author$project$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						h: index,
...
var $author$project$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, aw: length, e: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	...
	return A2($elm$regex$Regex$contains, $author$project$Markdown$InlineParser$urlRegex, match.c) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				j: $author$project$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.c,
	...
	function (matchModel, references, maybeRegexMatch) {
		...
		if (_v0.$ === 1) {
			...
			return $elm$core$Maybe$Just(
				_Utils_update(
					matchModel,
					{U: matchModel.U + regexMatchLength, j: type_}));
		}
	});
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						U: matchModel.U + $elm$core$String$length(regexMatch.ab),
						j: function () {
...
var $author$project$Markdown$InlineParser$checkParsedAheadOverlapping = F2(
	function (_v0, remainMatches) {
		...
		var overlappingMatches = $elm$core$List$filter(
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.U, testMatch.J) > 0) && (_Utils_cmp(match.U, testMatch.U) < 0);
			});
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aL: 1, f: _List_Nil, g: 1, d: 0, cg: 1, ar: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {a_: htmlTag, aw: endOffset - startOffset};
							})),
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.ao, open.aq) || _Utils_eq(close.ao, close.aq)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.aw + openToken.aw))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.aw)) && (!A2($elm$core$Basics$modBy, 3, openToken.aw)))) : true) : false;
			} else {
				return false;
			}
		} else {
...
var $author$project$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {U: token.h + token.aw, p: _List_Nil, J: token.h, c: '', w: 0, r: 0, j: type_};
	});
...
var $author$project$Markdown$InlineParser$removeParsedAheadTokens = F2(
	function (_v0, tokensTail) {
		...
		return A2(
			$elm$core$List$filter,
			function (token) {
				return _Utils_cmp(token.h, match.U) > -1;
			},
			tokensTail);
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{h: openToken.h + 1, aw: openToken.aw - 1});
			} else {
				return openToken;
			}
		}();
...
var $author$project$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var updt = (!remainLength) ? {am: closeToken, ac: openToken, ap: remainTokens, at: tokensTail} : ((remainLength > 0) ? {
			am: closeToken,
			ac: _Utils_update(
				openToken,
				{h: openToken.h + remainLength, aw: closeToken.aw}),
			ap: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			at: A2(
				...
				_Utils_update(
					closeToken,
					{h: closeToken.h + openToken.aw, aw: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$author$project$Markdown$InlineParser$tokenPairToMatch,
			...
			$author$project$Markdown$InlineParser$EmphasisType(updt.ac.aw),
			updt.ac,
			updt.am,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.at, match, updt.ap);
	});
		...
		var inactivateLinkOpenToken = function (token) {
			...
			if (_v16.$ === 1) {
				return _Utils_update(
					token,
					{
						e: $author$project$Markdown$InlineParser$LinkOpenToken(1)
					});
			} else {
				return token;
			}
...
var $author$project$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.h + openToken.aw;
		var textEnd = closeToken.h;
		var text = processText(
			A3($elm$core$String$slice, textStart, textEnd, rawText));
		var start = openToken.h;
		var end = closeToken.h + closeToken.aw;
		var match = {U: end, p: _List_Nil, J: start, c: text, w: textEnd, r: textStart, j: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {U: end, p: matches, J: start, c: text, w: textEnd, r: textStart, j: type_};
	});
			...
			return A3(
				...
				F2(
					function (headerCell, alignment) {
						return {ah: alignment, V: headerCell};
					}),
				headers,
				columnAlignments);
		};
...
var $author$project$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $author$project$Markdown$CodeBlock$backtick = {ak: '`', an: 0, as: $author$project$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		var builtTokens = A3(
			...
			A2(
				...
				minLength,
				$elm$parser$Parser$Advanced$token(fenceCharacter.as)));
		return A2(
			$elm$parser$Parser$Advanced$mapChompedString,
			F2(
				function (str, _v0) {
...
var $author$project$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $author$project$Markdown$CodeBlock$tilde = {ak: '~', an: 1, as: $author$project$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {al: character, av: indent, aw: length};
					})),
...
var $elm$parser$Parser$Advanced$getSource = function (s) {
	return A3($elm$parser$Parser$Advanced$Good, false, s.ar, s);
};
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($author$project$Markdown$CodeBlock$closingFence, fence.aw, fence.al))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
					A2(
						...
						$author$project$Markdown$CodeBlock$codeBlockLine(fence.av)),
					$elm$parser$Parser$Advanced$getOffset),
	...
	function (fence) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$author$project$Markdown$CodeBlock$infoString(fence.al),
					$author$project$Helpers$lineEndOrEnd)),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.d, s.cg, s.aL, s.ar);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$Located = F3(
	function (row, col, context) {
		return {aL: col, f: context, cg: row};
	});
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {aL: s.aL, f: newContext, g: s.g, d: s.d, cg: s.cg, ar: s.ar};
	});
		...
		return function (s0) {
			var _v1 = parse(
				A2(
					...
					A2(
						$elm$core$List$cons,
						A3($elm$parser$Parser$Advanced$Located, s0.cg, s0.aL, context),
						s0.f),
					s0));
			if (!_v1.$) {
				var p = _v1.a;
		...
		F2(
			function (delimiterText, revDelimiterColumns) {
				return A2(
					...
					{
						bh: delimiterText,
						bG: $elm$core$String$trim(delimiterText)
					},
					A2(
						$elm$core$List$map,
		...
		function (listmarker, unparsedListItem) {
			switch (unparsedListItem.$) {
				...
				case 1:
					...
					return {bQ: body, b5: listmarker, l: $elm$core$Maybe$Nothing};
				default:
					return {bQ: '', b5: listmarker, l: $elm$core$Maybe$Nothing};
			}
		});
	return A2(
		$elm$parser$Parser$Advanced$map,
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$author$project$Markdown$RawBlock$CodeBlock(
											{
												bQ: A2($author$project$Markdown$Parser$joinStringsPreserveAll, block2.bQ, block1.bQ),
					...
					case 3:
						...
						switch (newRawBlock.$) {
							case 3:
								...
								if (_Utils_eq(openListItem2.b5, openListItem1.b5)) {
									var _v59 = A2(
										$elm$parser$Parser$Advanced$run,
										$author$project$Markdown$Parser$cyclic$rawBlockParser(),
										openListItem2.bQ);
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														bQ: A3($author$project$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.bQ, body1)
													})),
											rest)
									});
							default:
			...
			function (_v24) {
				...
				return A3(
					...
					function (parsedHeaderLabel) {
						return {ah: alignment, V: parsedHeaderLabel};
					},
					label);
			},
			header);
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
					...
					A2(
						...
						$elm$core$List$reverse(
							A2(
								$elm$core$List$map,
								function (item) {
									return A2(parseItem, item.l, item.bQ);
								},
								unparsedItems))));
			case 4:
				var tight = rawBlock.a;
			...
			case 6:
				...
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$CodeBlock(
						{bQ: codeBlockBody, b4: $elm$core$Maybe$Nothing}));
			case 8:
				var _v22 = rawBlock.a;
				var header = _v22.a;
				var rows = _v22.b;
			...
			case 9:
				...
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$Paragraph(
						A2($author$project$Markdown$Parser$inlineParseHelper, linkReferences, text.bh)));
			default:
				var raw = rawBlock.b;
				return $author$project$Markdown$Parser$ParsedBlock(
					$author$project$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	bQ: A3($author$project$Markdown$Parser$joinRawStringsWith, '', openListItem.bQ, newString)
																})),
														rest))
											});
									});
								...
								if (_v3.b.b) {
									switch (_v3.b.a.$) {
										case 3:
											...
											return ($elm$core$String$trim(openListItem.bQ) === '') ? A2(
												$elm$parser$Parser$Advanced$map,
												function (block) {
													return $elm$parser$Parser$Advanced$Loop(block);
												},
	...
	return function (block) {
		switch (block.$) {
							...
							return renderer.aW(
								{
									aI: children,
									a4: level,
									bi: $author$project$Markdown$Block$extractInlineText(content)
								});
						},
			...
			case 7:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.aJ(codeBlock)));
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.bD));
			case 3:
...
var $author$project$Markdown$Renderer$renderSingleInline = F2(
	function (renderer, inline) {
		switch (inline.$) {
			...
			case 2:
				...
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(
						renderer.a$(
							{
								ai: $author$project$Markdown$Block$extractInlineText(children),
								ar: src,
								cm: title
							})));
			case 7:
			...
			case 8:
				return $elm$core$Maybe$Just(
					$elm$core$Result$Ok(renderer.aV));
			default:
				var html = inline.a;
				if (!html.$) {
					var tag = html.a;
		...
		function () {
			...
			if (!_v0.$) {
				...
				return A2(
					...
					A4(
						$elm_community$string_extra$String$Extra$replaceSlice,
						'<highlight>' + (A3($elm$core$String$slice, candidate.h, endIndex, model.c) + '</highlight>'),
						candidate.h,
						endIndex,
						model.c));
			} else {
				return A2($author$project$AonTool$viewMarkdown, model, model.c);
			}
		}());
};
			...
			[
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(
									$elm$core$List$length(model.t)) + ' documents loaded'),
								A2(
								$elm$html$Html$button,
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$AonTool$FormatCritEffectsPressed)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Format CritEffects')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$AonTool$FormatActionPressed)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Format Action')
							]))
					])),
				A2(
				$elm$html$Html$div,
...
var $author$project$AonTool$main = $elm$browser$Browser$element(
	{b1: $author$project$AonTool$init, ck: $author$project$AonTool$subscriptions, co: $author$project$AonTool$update, cp: $author$project$AonTool$view});
