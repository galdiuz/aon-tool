...
var $author$project$AonTool$updateCandidates = function (_v0) {
				...
				A2(
					...
					function (document) {
						return A2(
							...
							$elm$core$String$toLower(model.c)) && ((!((document.N === 'creature') && (document.i === 'I'))) && (!((document.N === 'rules') && A2(
	...
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{ai: candidates, O: $elm$core$Maybe$Nothing}),
		cmd);
};
	...
	return function (_v0) {
		...
		_Utils_Tuple2(
			function (model) {
				...
				{M: 'https://2e.aonprd.com', ai: _List_Nil, O: $elm$core$Maybe$Nothing, x: 0, t: _List_Nil, Z: 'https://elasticsearch.aonprd.com/aon', A: '', s: $author$project$AonTool$emptySelection, c: ''}),
...
var $author$project$AonTool$addLinkTag = F2(
	function (document, string) {
		return (document.N === 'spell') ? ($author$project$AonTool$getDocumentLink(document) + ('<i>' + (string + '</i><%END>'))) : ($author$project$AonTool$getDocumentLink(document) + (string + '<%END>'));
	});
				...
				$elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'category',
							$elm$json$Json$Encode$string(document.N)),
							_Utils_Tuple2(
							'name',
			...
			case 11:
				...
				if (!result.$) {
					...
					return ((_Utils_cmp(
						...
						$elm$core$Maybe$Just(searchResult.az)))(
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
...
var $author$project$AonTool$ConvertToListPressed = {$: 4};
var $author$project$AonTool$CopyFirstSentenceToClipboardPressed = {$: 6};
var $author$project$AonTool$CopyToClipboardPressed = {$: 5};
var $author$project$AonTool$ElasticUrlChanged = function (a) {
	return {$: 8, a: a};
};
var $author$project$AonTool$FixNewlinesPressed = {$: 9};
var $author$project$AonTool$PasteFromClipboardPressed = {$: 13};
var $author$project$AonTool$RefreshDataPressed = {$: 14};
...
var $dillonkearns$elm_markdown$Markdown$Parser$deadEndToString = function (deadEnd) {
	return 'Problem at row ' + ($elm$core$String$fromInt(deadEnd.cg) + ('\n' + $dillonkearns$elm_markdown$Markdown$Parser$problemToString(deadEnd.cd)));
};
...
var $author$project$AonTool$addSpaces = function (inline) {
	if (inline.$ === 7) {
		...
		return A2(
			...
			text) ? $dillonkearns$elm_markdown$Markdown$Block$Text(text + ' ') : $dillonkearns$elm_markdown$Markdown$Block$Text(' ' + (text + ' '));
	} else {
		return inline;
	}
};
	...
	a$: function (imageInfo) {
		...
		if (!_v5.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$src(imageInfo.aB),
...
var $author$project$AonTool$markdownHtmlRenderer = function (model) {
	return $dillonkearns$elm_markdown$Markdown$Html$oneOf(
		_List_fromArray(
			[
				A2(
...
var $author$project$AonTool$markdownRenderer = function (model) {
	var defaultRenderer = $dillonkearns$elm_markdown$Markdown$Renderer$defaultHtmlRenderer;
	return {
		aG: A2(
			$elm$core$Basics$composeR,
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.aB);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.d, offset) < 0,
					0,
					{aL: col, f: s0.f, g: s0.g, d: offset, cg: row, aB: s0.aB});
			} else {
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.d, s.cg, s.aL, s.aB);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aL: newCol, f: s.f, g: s.g, d: newOffset, cg: newRow, aB: s.aB});
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.d, s1.d, s0.aB),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.d, s.aB);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{aL: 1, f: s.f, g: s.g, d: s.d + 1, cg: s.cg + 1, aB: s.aB}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aL: s.aL + 1, f: s.f, g: s.g, d: newOffset, cg: s.cg, aB: s.aB}));
		};
	});
...
var $elm$parser$Parser$Advanced$chompUntilEndOr = function (str) {
	return function (s) {
		var _v0 = A5(_Parser_findSubString, str, s.d, s.cg, s.aL, s.aB);
		var newOffset = _v0.a;
		var newRow = _v0.b;
		var newCol = _v0.c;
		var adjustedOffset = (newOffset < 0) ? $elm$core$String$length(s.aB) : newOffset;
		return A3(
			$elm$parser$Parser$Advanced$Good,
			_Utils_cmp(s.d, adjustedOffset) < 0,
			0,
			{aL: newCol, f: s.f, g: s.g, d: adjustedOffset, cg: newRow, aB: s.aB});
	};
};
...
var $dillonkearns$elm_markdown$Markdown$Parser$orderedListBlock = function (previousWasBody) {
	return A2(
		$elm$parser$Parser$Advanced$map,
		function (item) {
			return A6($dillonkearns$elm_markdown$Markdown$RawBlock$OrderedListBlock, true, item.b2, item.b5, item.cc, _List_Nil, item.bQ);
		},
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $dillonkearns$elm_markdown$Markdown$Inline$Text(match.c);
		case 1:
			return $dillonkearns$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $dillonkearns$elm_markdown$Markdown$Inline$CodeInline(match.c);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		p: _List_Nil,
		J: 0,
		c: $dillonkearns$elm_markdown$Markdown$Helpers$formatStr(text),
		w: 0,
		r: 0,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = {
			U: matchModel.U,
			p: A3($dillonkearns$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.c, _List_Nil, matchModel.p),
			J: matchModel.J,
			c: matchModel.c,
			w: matchModel.w,
			r: matchModel.r,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, av: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$AngleBracketOpen}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				h: regMatch.h + backslashesLength,
				av: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{h: (regMatch.h + backslashesLength) - 1, av: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							h: regMatch.h,
							av: $elm$core$String$length(regMatch.ab),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{h: regMatch.h + backslashesLength, av: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{h: (regMatch.h + backslashesLength) - 1, av: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageCloseToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var backslashesLength = A2(
			...
			A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
		return $dillonkearns$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, av: 1, e: $dillonkearns$elm_markdown$Markdown$InlineParser$SquareBracketClose}) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		if (isEscaped) {
			...
			if (!maybeImageOpen.$) {
				return $elm$core$Maybe$Just(
					{h: index, av: 2, e: $dillonkearns$elm_markdown$Markdown$InlineParser$ImageOpenToken});
			} else {
				return $elm$core$Maybe$Just(
					{
						h: index,
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$regMatchToStrikethroughToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		var meaning = _v2.b;
		return $elm$core$Maybe$Just(
			{h: regMatch.h + backslashesLength, av: length, e: meaning});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$urlRegex, match.c) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				j: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.c,
						$dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.c)))
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $dillonkearns$elm_markdown$Markdown$InlineParser$emailRegex, match.c) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				j: $dillonkearns$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.c,
						'mailto:' + $dillonkearns$elm_markdown$Markdown$InlineParser$encodeUrl(match.c)))
			})) : $elm$core$Result$Err(match);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aL: 1, f: _List_Nil, g: 1, d: 0, cg: 1, aB: src});
		if (!_v1.$) {
			var value = _v1.b;
					...
					$elm$parser$Parser$Advanced$succeed(
						F3(
							function (startOffset, htmlTag, endOffset) {
								return {a_: htmlTag, av: endOffset - startOffset};
							})),
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			if (!_v0.a) {
				var _v1 = _v0.a;
				return _Utils_eq(openToken.av - 1, closeToken.av);
			} else {
				var _v2 = _v0.a;
				return _Utils_eq(openToken.av, closeToken.av);
			}
		} else {
			return false;
		}
	...
	function (closeToken, openToken) {
		...
		if (_v0.$ === 7) {
			...
			if (_v1.$ === 7) {
				var closeChar = _v1.a;
				var close = _v1.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(open.an, open.ap) || _Utils_eq(close.an, close.ap)) ? ((!(!A2($elm$core$Basics$modBy, 3, closeToken.av + openToken.av))) || ((!A2($elm$core$Basics$modBy, 3, closeToken.av)) && (!A2($elm$core$Basics$modBy, 3, openToken.av)))) : true) : false;
			} else {
				return false;
			}
		} else {
	...
	function (closeToken, openToken) {
		var _v0 = function () {
			...
			if (_v1.$ === 9) {
				if (!_v1.a) {
					var _v2 = _v1.a;
					return _Utils_Tuple2(true, openToken.av - 1);
				} else {
					var _v3 = _v1.a;
					return _Utils_Tuple2(true, openToken.av);
				}
			} else {
		...
		var _v4 = function () {
			...
			if (_v5.$ === 9) {
				if (!_v5.a) {
					var _v6 = _v5.a;
					return _Utils_Tuple2(true, closeToken.av - 1);
				} else {
					var _v7 = _v5.a;
					return _Utils_Tuple2(true, closeToken.av);
				}
			} else {
				return _Utils_Tuple2(false, 0);
			}
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {U: token.h + token.av, p: _List_Nil, J: token.h, c: '', w: 0, r: 0, j: type_};
	});
	...
	function (closeToken, matches, references, rawText, _v32) {
		...
		var updatedOpenToken = function () {
			...
			if ((!_v33.$) && (!_v33.a)) {
				...
				return _Utils_update(
					openToken,
					{h: openToken.h + 1, av: openToken.av - 1});
			} else {
				return openToken;
			}
		}();
	...
	function (remaining, tokens, matches, references, rawText) {
		...
		while (true) {
			if (!remaining.b) {
				...
				if (_v27.$ === 7) {
					var _char = _v27.a;
					var leftFringeRank = _v27.b.an;
					var rightFringeRank = _v27.b.ap;
...
var $dillonkearns$elm_markdown$Markdown$InlineParser$emphasisToMatch = F5(
	function (references, rawText, closeToken, tokensTail, _v25) {
		...
		var remainLength = openToken.av - closeToken.av;
		var updt = (!remainLength) ? {al: closeToken, ac: openToken, ao: remainTokens, ar: tokensTail} : ((remainLength > 0) ? {
			al: closeToken,
			ac: _Utils_update(
				openToken,
				{h: openToken.h + remainLength, av: closeToken.av}),
			ao: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			ar: A2(
				...
				_Utils_update(
					closeToken,
					{h: closeToken.h + openToken.av, av: -remainLength}),
				tokensTail)
		});
		var match = A7(
			$dillonkearns$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$dillonkearns$elm_markdown$Markdown$InlineParser$EmphasisType(updt.ac.av),
			updt.ac,
			updt.al,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple3(updt.ar, match, updt.ao);
	});
...
var $dillonkearns$elm_markdown$Parser$Token$backtick = A2(
	...
	'`',
	$elm$parser$Parser$Expecting('a \'`\''));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$backtick = {aj: '`', am: 0, aq: $dillonkearns$elm_markdown$Parser$Token$backtick};
	...
	function (minLength, fenceCharacter) {
		...
		return A2(
			...
			A2(
				...
				builtTokens,
				$elm$parser$Parser$Advanced$chompWhile(
					$elm$core$Basics$eq(fenceCharacter.aj))));
	});
...
var $dillonkearns$elm_markdown$Parser$Token$tilde = A2(
	...
	'~',
	$elm$parser$Parser$Expecting('a `~`'));
var $dillonkearns$elm_markdown$Markdown$CodeBlock$tilde = {aj: '~', am: 1, aq: $dillonkearns$elm_markdown$Parser$Token$tilde};
			...
			$elm$parser$Parser$Advanced$succeed(
				F2(
					function (indent, _v0) {
						var character = _v0.a;
						var length = _v0.b;
						return {ak: character, au: indent, av: length};
					})),
		...
		_List_fromArray(
			[
				...
				A2(
					...
					$elm$parser$Parser$Advanced$succeed(
						$elm$parser$Parser$Advanced$Done(body)),
					A2($dillonkearns$elm_markdown$Markdown$CodeBlock$closingFence, fence.av, fence.ak))),
				A2(
				$elm$parser$Parser$Advanced$keeper,
				A2(
					$elm$parser$Parser$Advanced$keeper,
	...
	function (fence) {
		return A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$Advanced$ignorer,
					$dillonkearns$elm_markdown$Markdown$CodeBlock$infoString(fence.ak),
					$dillonkearns$elm_markdown$Helpers$lineEndOrEnd)),
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.d, s.cg, s.aL, s.aB);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $elm$parser$Parser$Advanced$changeContext = F2(
	function (newContext, s) {
		return {aL: s.aL, f: newContext, g: s.g, d: s.d, cg: s.cg, aB: s.aB};
	});
							...
							return $elm$parser$Parser$Advanced$succeed(
								{
									...
									b: A2(
										...
										$dillonkearns$elm_markdown$Markdown$RawBlock$CodeBlock(
											{
												bQ: A2($dillonkearns$elm_markdown$Markdown$Parser$joinStringsPreserveAll, block2.bQ, block1.bQ),
										...
										b: A2(
											...
											A4(
												...
												_Utils_update(
													openListItem2,
													{
														bQ: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '\n', openListItem2.bQ, body1)
													})),
											rest)
									});
							default:
	...
	function (linkReferences, rawBlock) {
		switch (rawBlock.$) {
			...
			case 9:
				...
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
						A2($dillonkearns$elm_markdown$Markdown$Parser$inlineParseHelper, linkReferences, text.bh)));
			default:
				var raw = rawBlock.b;
				return $dillonkearns$elm_markdown$Markdown$Parser$ParsedBlock(
					$dillonkearns$elm_markdown$Markdown$Block$Paragraph(
													...
													A2(
														...
														A4(
															...
															_Utils_update(
																openListItem,
																{
																	bQ: A3($dillonkearns$elm_markdown$Markdown$Parser$joinRawStringsWith, '', openListItem.bQ, newString)
																})),
														rest))
											});
									});
							...
							return renderer.aW(
								{
									aI: children,
									a4: level,
									bi: $dillonkearns$elm_markdown$Markdown$Block$extractInlineText(content)
								});
						},
	...
	function (model, text) {
		var markdown = A2(
			...
			A2(
				$elm$core$Result$map,
				$elm$core$List$map(
					$dillonkearns$elm_markdown$Markdown$Block$walk($author$project$AonTool$fixMarkdownSpacing)),
				$dillonkearns$elm_markdown$Markdown$Parser$parse(
					A3(
						$elm$regex$Regex$replace,
						$author$project$AonTool$regexFromString('<%(.+?)%(.+?)%%>(.+?)<%END>'),
						function (match) {
							var getSubmatch = function (index) {
								return A2(
									$elm$core$Maybe$withDefault,
									'',
									$elm_community$maybe_extra$Maybe$Extra$join(
							...
							return '<link code=\"' + (getSubmatch(0) + ('\" id=\"' + (getSubmatch(1) + ('\">' + (getSubmatch(2) + '</link>')))));
						},
						text))));
		if (!markdown.$) {
