...
{
	if (region.K._ === region.U._)
	{
		return 'on line ' + region.K._;
	}
	return 'on lines ' + region.K._ + ' through ' + region.U._;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.b6, request.M, true);
		} catch (e) {
...
var $author$project$AonTool$emptySelection = {U: 0, K: 0, c: ''};
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{bO: false, bQ: r.bQ, bX: r.bX, bZ: r.bZ, b6: r.b6, cl: r.cl, cn: r.cn, M: r.M}));
};
				...
				_List_fromArray(
					[
						...
						$elm$http$Http$request(
						{
							...
							M: model.Z + '/_search?track_total_hits=true'
						})
					])));
	});
...
var $author$project$AonTool$updateCandidates = function (_v0) {
	...
	var candidates = A2(
		...
		A2(
			...
			function (candidate) {
				return (model.s.c !== '') ? ((_Utils_cmp(candidate.h, model.s.K) > -1) && (_Utils_cmp(candidate.h, model.s.U) < 0)) : true;
			},
			A2(
	...
	return function (_v0) {
		...
		_Utils_Tuple2(
			function (model) {
				...
				{G: 'https://2e.aonprd.com', aj: _List_Nil, N: $elm$core$Maybe$Nothing, x: 0, t: _List_Nil, Z: 'https://elasticsearch.aonprd.com/aon', A: '', s: $author$project$AonTool$emptySelection, c: ''}),
				...
				return $author$project$AonTool$updateCandidates(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{
								c: A3($elm_community$string_extra$String$Extra$insertAt, '<br />', model.s.K, model.c)
							}),
						$elm$core$Platform$Cmd$none));
			case 1:
				var value = msg.a;
								...
								[
									...
									_List_fromArray(
										[
											...
											_Utils_ap(model.G, candidate.k.M)),
											$elm$html$Html$Attributes$target('_blank')
										]),
									_List_fromArray(
										[
											$elm$html$Html$text(candidate.k.M)
										]))
								])),
							A2(
							$elm$html$Html$div,
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$Attributes$href(
													_Utils_ap(model.G, document.M)),
													$elm$html$Html$Attributes$target('_blank')
												]),
											_List_fromArray(
												[
													$elm$html$Html$text(document.M)
												]))
										])),
									A2(
									$elm$html$Html$button,
...
var $author$project$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return {U: childMatch.U - parentMatch.r, p: childMatch.p, K: childMatch.K - parentMatch.r, c: childMatch.c, w: childMatch.w - parentMatch.r, r: childMatch.r - parentMatch.r, j: childMatch.j};
	});
	...
	function (remaining, _v0, matchesTail) {
		...
		while (true) {
			...
			if (!remaining.b) {
				...
				if (_Utils_cmp(prevMatch.U, match.K) < 1) {
					...
					if ((_Utils_cmp(prevMatch.K, match.K) < 0) && (_Utils_cmp(prevMatch.U, match.U) > 0)) {
						var $temp$remaining = rest,
	...
	function (rawText, _v2, parsedMatches) {
		...
		if (!parsedMatches.b) {
			...
			if (!_v4.$) {
				...
				return _Utils_eq(matchModel.U, matchHead.K) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.U, matchHead.K) < 0) ? A2(
					$elm$core$List$cons,
					updtMatch,
					A2(
						$elm$core$List$cons,
						$author$project$Markdown$InlineParser$normalMatch(
							A3($elm$core$String$slice, matchModel.U, matchHead.K, rawText)),
...
var $author$project$Markdown$InlineParser$checkParsedAheadOverlapping = F2(
	function (_v0, remainMatches) {
		...
		var overlappingMatches = $elm$core$List$filter(
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.U, testMatch.K) > 0) && (_Utils_cmp(match.U, testMatch.U) < 0);
			});
...
var $author$project$Markdown$InlineParser$htmlToToken = F2(
	function (rawText, _v0) {
		...
		if (!parsed.$) {
			...
			return $elm$core$Maybe$Just(
				{h: match.K, aw: length, e: htmlToken});
		} else {
			return $elm$core$Maybe$Nothing;
		}
	});
...
var $author$project$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {U: token.h + token.aw, p: _List_Nil, K: token.h, c: '', w: 0, r: 0, j: type_};
	});
...
var $author$project$Markdown$InlineParser$tokenPairToMatch = F7(
	function (references, rawText, processText, type_, openToken, closeToken, innerTokens) {
		...
		var match = {U: end, p: _List_Nil, K: start, c: text, w: textEnd, r: textStart, j: type_};
		var matches = A2(
			$elm$core$List$map,
			function (_v0) {
				var matchModel = _v0;
		...
		return {U: end, p: matches, K: start, c: text, w: textEnd, r: textStart, j: type_};
	});
